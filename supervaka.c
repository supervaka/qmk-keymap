...
const uint16_t PROGMEM combo_left[] = {KC_J, KC_K, COMBO_END};
const uint16_t PROGMEM combo_down[] = {KC_UP, KC_DOWN, COMBO_END};
const uint16_t PROGMEM combo_right[] = {KC_L, KC_SCLN, COMBO_END};

// const uint16_t PROGMEM combo_capsword[] = {KC_L, KC_SCLN, COMBO_END};

combo_t key_combos[] = {COMBO(test_combo1, C(KC_C)),
